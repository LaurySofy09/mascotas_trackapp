                ...
                <div class="card-body" style="padding: 30px; margin-bottom:40px;">
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                      <a href="Tabs.php?vu=<?php echo $IdUsuario; ?>" style="font-size: 1rem;"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Editar</a>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div id="qrcode">
                        </div>
                          <input class="form-control" id="text" type="text" value="<?php echo 'https://b3de-200-46-165-56.ngrok-free.app/mascotaproject_v1.0/pet.php'.'?vu='.$IdUsuario; ?>" style="width:80%; display: none;" />
                      <br/>
                    </div>
