      ...
      <form action="<?php echo "postRegistroMascota.php"; ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                 <input class="form-control" type="file" name="profilepic" id="profile-picture-input" accept="image/*" placeholder="Foto" required/>
            </div>
        </div>
        <script>
        ...
        <div class="row">
          ...
          <div class="row">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="input-box" style="position: relative;">
                <span class="details" for="ddlTipoMascota" style="width: 150px;">Tipo de mascota</span>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="input-box" style="position: relative;">
              <span class="details" for="txtFechaNacimientoMascota" style="width: 180px;">Fecha de nacimiento</span>
