...
include ("BDClass.php");
    ...
    $usuario_HDusr  = $_REQUEST["HDusr_usr"];
    $idMascota = $_REQUEST["HDm_usr"];
    $Edad =$_REQUEST["EdadMascota_usr"];
    $FechaNacimientoMascota =$_REQUEST["FechaNacimientoMascota_usr"];
    $PesoMascota =$_REQUEST["PesoMascota_usr"];
    $foto = $_REQUEST["profilepic_usr"];
    $radEsterilizado =$_REQUEST["radEsterilizado_usr"];
    $vacunas = $_REQUEST["HDvc_usr"];
    $InformacionAdicional =$_REQUEST["InformacionAdicional_usr"];
    $InformacionVet =$_REQUEST["InformacionVet_usr"];
