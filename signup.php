      ...
      <form action="<?php echo "registroNewUser.php"; ?>" method="POST" enctype="multipart/form-data">
        <div class="user-details">
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Nombre y Apellido</span>
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Usuario</span>
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Contraseña</span>
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Confirmar Contraseña</span>
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Cédula o Pasaporte</span>
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Fecha de nacimiento</span>
        ...
        <div class="input-box" style="position: relative;">
          <span class="details asterisco">Teléfono principal</span>
        ...
        <div class="input-box" style="position: relative;">
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Email</span>
          ...
          <div class="input-box" style="position: relative;">
            <span class="details asterisco">Dirección</span>
